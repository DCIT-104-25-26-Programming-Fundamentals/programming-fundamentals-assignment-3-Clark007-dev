...
function main() {
  ...
  while (running) {
    ...
    if (choice === 1) {
      ...
      console.log(`Result: ${first} + ${second} = ${add(first, second).toFixed(2)}`);
    } else if (choice === 2) {
      const { first, second } = getTwoNumbers();
      console.log(`Result: ${first} - ${second} = ${subtract(first, second).toFixed(2)}`);
    } else if (choice === 3) {
      const { first, second } = getTwoNumbers();
      console.log(`Result: ${first} * ${second} = ${multiply(first, second).toFixed(2)}`);
    } else if (choice === 4) {
      const { first, second } = getTwoNumbers();
      ...
      const { first, second } = getTwoNumbers();
      console.log(`Result: ${first} ** ${second} = ${exponentiate(first, second).toFixed(2)}`);
    } else if (choice === 7) {
      console.log("Goodbye!");
      running = false;
    } else {
